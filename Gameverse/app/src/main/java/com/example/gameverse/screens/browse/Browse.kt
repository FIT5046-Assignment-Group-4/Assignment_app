package com.example.gameverse.screens.browse
...
import com.example.gameverse.components.SearchBar
                ...
                items(gameList) { item ->
                    Card(
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(5.dp)
                            .clickable(onClick = { navController.navigate(Routes.Report.value + "/${item.id}") }),
